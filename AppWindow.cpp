...
void AppWindow::updateModel()
{
	...
	m_light_rot_matrix.setRotationY(m_light_rot_y);//m_light_rot_y

	m_light_rot_y += 0.307f * m_delta_time;//0.785f
	...
	//std::cout << "Light Direction: " << cc.m_light_direction.m_x << ", " << cc.m_light_direction.m_y << ", " << cc.m_light_direction.m_z << std::endl;
	//std::cout << "m_light_rot_y: " << m_light_rot_y << std::endl;
